...
package org.example.demoGeneralites.implementationClasse.exClasseCompte;
...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("===> COMPTE N°1 _ état initial : "+compte1);

        // Instanciation d'un objet compte 2
        Compte compte2= new Compte(2,6000.f);
        System.out.println("===> COMPTE N°2 _ état initial : "+compte2);
